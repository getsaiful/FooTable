...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            all : {
                ...
                files: {
                    ...
                    'dist/footable.memory.min.js': ['js/footable.memory.js'],
		...
		concat: {
			...
			dist: {
				src: [ 'dist/footable.min.js', 'dist/footable.memory.min.js', 'dist/footable.grid.min.js', 'dist/footable.filter.min.js', 'dist/footable.paginate.min.js', 'dist/footable.sort.min.js', 'dist/footable.striping.min.js', 'dist/footable.bookmarkable.min.js' ],
